...
// OpenFromHandle creates a Device from an already-open libusb device handle.
// This is useful for Android/Termux where devices must be opened via file descriptors.
